...
export function AuditLogView() {
  ...
  const exportCsv = () => {
    ...
    const rows = [['Timestamp', 'User', 'Role', 'Action', 'Target', 'Detail', 'IP'], ...logs.map(l => [new Date(l.createdAt).toISOString(), l.adminUser?.name || '', l.adminUser?.role || '', l.action, l.target || '', l.detail || '', l.ipAddress || ''])]
