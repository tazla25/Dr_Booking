      ...
      <Dialog open={open} onOpenChange={(o) => { setOpen(o); if (!o) { setPatientName(''); setPatientPhone(''); setScheduleId('') } }}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3 py-2">
            ...
            <div className="space-y-2"><Label>Patient phone (optional)</Label><Input value={patientPhone} onChange={(e) => setPatientPhone(e.target.value)} placeholder="e.g., +919876543210" onKeyDown={(e) => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); submit() } }} /></div>
